...
function _typeof(e) {
    ...
    r.defaults = {
        ...
        Promise.all([Promise.all(r).then(function () {
            n.debug && console.log("%c[components]: scriptsReady", "color: orange; font-weight: 900;"), n.onScriptsReady instanceof Function && n.onScriptsReady.call(n), window.dispatchEvent(new CustomEvent("components:scriptsReady"))
        }), Promise.all(o).then(function () {
            n.debug && console.log("%c[components]: stylesReady", "color: orange; font-weight: 900;"), n.onStylesReady instanceof Function && n.onStylesReady.call(n), window.dispatchEvent(new CustomEvent("components:stylesReady"))
        })]).then(function () {
